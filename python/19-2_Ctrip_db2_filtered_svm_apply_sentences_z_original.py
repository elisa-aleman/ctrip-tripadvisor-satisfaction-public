...
def Tag_Ctrip_db2_sentences__mutual_filter_tripadvisor_date_hotel_name():
    # Load corpus
    sentences_df = get_Ctrip_db2_chinese_sentences__mutual_filter_tripadvisor_date_hotel_name_df()
    ...
    sentences_df.insert(6,"Positive_Prediction", predicted)
    predict_path = make_data_path("ctrip/ctrip_db2/sentences_predicted_Combined_Keywords_Z_original_p2.75_n3.75_zh-cn_chinese_only_mutual_filter_tripadvisor_date_hotel_name.csv")
    sentences_df.to_csv(predict_path, index=False)

if __name__ == '__main__':
    Tag_Ctrip_db2_sentences__mutual_filter_tripadvisor_date_hotel_name()