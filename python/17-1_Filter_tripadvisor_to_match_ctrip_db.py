...
def get_Ctrip_db_date_range():
    ctrip_df = get_Ctrip_db_comments_df()
    dates = pandas.to_datetime(ctrip_df.Date)
    earliest = dates.min()
    latest = dates.max()
    return earliest,latest

def filter_Tripadvisor_by_Ctrip_db_date():
    earliest,latest = get_Ctrip_db_date_range()
    ...
    filtered_path = make_data_path("tripadvisor/tripadvisor_db/sentences_english_only_filtered_ctrip_db_date.csv")
    filtered_trip.to_csv(filtered_path, index=False)

def filter_Tripadvisor_by_Ctrip_db_date_hotel_name():
    ...
    # Load sentences
    sentences_path = make_data_path("tripadvisor/tripadvisor_db/sentences_english_only_filtered_ctrip_db_date.csv")
    ...
    filtered_path = make_data_path("tripadvisor/tripadvisor_db/sentences_english_only_filtered_ctrip_db_date_hotel-name.csv")
    filtered.to_csv(filtered_path,index=False)

def filter_Tripadvisor_by_Ctrip_db_date_hotel_price():
    ctrip_hotels = get_Ctrip_db_hotels_df()
    ...
    filtered_path = make_data_path("tripadvisor/tripadvisor_db/sentences_english_only_filtered_ctrip_db_date_hotel-price.csv")
    filtered.to_csv(filtered_path,index=False)


if __name__ == '__main__':
    # filter_Tripadvisor_by_Ctrip_db_date()
    # filter_Tripadvisor_by_Ctrip_db_date_hotel_name()
    # filter_Tripadvisor_by_Ctrip_db_date_hotel_price()